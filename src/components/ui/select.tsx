  ...
  return (
    <div className={`w-full flex flex-col gap-1.5 ${className}`} ref={containerRef}>
      ...
      <div className="relative">
        ...
        {isOpen && (
          <div className={`absolute z-50 w-full bg-[#0d141a] border border-white/10 rounded-xl shadow-2xl overflow-hidden animate-fade-in max-h-60 overflow-y-auto no-scrollbar backdrop-blur-xl ${
