            ...
            {loadingRecommendations ? (
              ...
              <div className="space-y-3 max-h-[500px] overflow-y-auto pr-1 no-scrollbar">
                {filteredRecommendations.map((action, index) => (
                  <div
                    key={index}
                    className="rounded-xl border border-white/5 hover:border-white/10 bg-white/2 p-3 flex flex-col justify-between gap-3 text-xs"
                  >
                    <div>
                    ...
                    <div className="flex justify-between items-center pt-2 border-t border-white/5">
                      ...
                      <button
                        disabled={addingId === action.title}
                        onClick={() => handleAddGoal(action.title, action.category, action.co2, action.diff)}
